...
//       try {
//        const response = await axios.post('https://burka-2-2.onrender.com/user/register', values);
...
const Registration = () => {
  ...
  return (
    <div className="max-w-4xl p-8 bg-white rounded-xl shadow-lg mt-10">
      <h2 className="text-2xl font-bold mb-6 text-center text-blue-600">
        🏢 Company Registration
      </h2>
      <form onSubmit={formik.handleSubmit} className="space-y-5">
        {/* Firm / Company Name - Full width */}
        <div>
          <label className="block font-medium mb-1">Firm / Company Name</label>
          <input
            type="text"
        ...
        {/* Contact Person Name and Type in one row */}
