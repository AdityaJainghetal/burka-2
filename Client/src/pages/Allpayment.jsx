...
const AllPayment = () => {
  ...
  useEffect(() => {
    const fetchOrderAndPayments = async () => {
      try {
        const orderRes = await axios.get(`https://burka-2.onrender.com/order/${id}`);
        setOrder(orderRes.data.order);

        const paymentsRes = await axios.get(`https://burka-2.onrender.com/payments/${id}`);
...
//     try {
//       const res = await axios.post('https://burka-2.onrender.com/payment', payload);
